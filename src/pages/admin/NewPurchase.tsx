...
import { eventsRef, purchasesRef, storage, usersRef } from '../../firebase'
...
function NewPurchase() {
    ...
    const setTitle = (value: string) => {
      setPurchase({ ...purchase, title: value })
    }
    const setAmount = (value: number) => {
        setPurchase({ ...purchase, amount: value })
    }
    const setDate = (value: string) => {
        console.log(value);
        setPurchase({...purchase, date: value});
    }
    ...
    const onPress = () => {
      ...
      const myDateeee = new Date(purchase.date)
      
      addDoc(purchasesRef, {...purchase, ownerId: user?.id, date: Timestamp.fromDate(myDateeee)}).then(eventFRef => {
